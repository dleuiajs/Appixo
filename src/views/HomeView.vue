...
import AppBigCardsCarousel from '@/components/AppBigCardsCarousel.vue';
...
<template>
  <div class="d-flex flex-column ga-3 mt-5 mb-10 px-5 mx-1">
    <span class="text-h5">Recommended app:</span>
    <AppBigCardsCarousel :appsLimit="6" />
  </div>
  <!-- lists -->
  <div class="d-flex flex-column ga-5 mb-10 px-5 mx-1">
    <div class="d-flex flex-column ga-3">
      <div class="d-flex flex-row align-center ga-5">
        ...
        <v-btn append-icon="mdi-arrow-right" variant="outlined" color="red-lighten-2" max-height="28" to="/apps/games">
